...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x00000db9ab318fc295ed87c33dffc64471a18bc910d53e961b3348d50301e142");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // FireGeek: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FireGeek Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000db9ab318fc295ed87c33dffc64471a18bc910d53e961b3348d50301e142");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1426592878;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2056171;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FireGeekMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FireGeekCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("FireGeekMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("FireGeek-miner");
    ...
    try { loop {
        ...
        printf("Running FireGeekMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FireGeekMiner terminated\n");
        throw;
    }
}
